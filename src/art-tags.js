/** 原創的致敬圖像，不是複製畫作、也不是畫家的真實簽名。
 * 歷史出處與晚期作品的呼應見 docs/ARTIST-TAGS.md。
 */
...
const tags=[
 ['文森・梵谷','sunflower','向日葵',['#efb93d','#c67a26','#417e68'],()=>{
 ...
 ['保羅・席涅克','dotted_sail','帆下的色點',['#65bccc','#ed9d5a','#fff0cd'],()=>{
 ...
 ['亨利・羅特列克','poster_star','歌舞廳的台柱',['#e6bc66','#cf645b','#24313b'],()=>path('M52 30 206 38 198 222 42 213Z','#e8bd6a',paper,5)+path('m187 43 9 19 21 2-16 14 4 21-18-10-18 10 4-21-16-14 21-2Z','#c64f48')+circle(117,76,13,ink)+path('M98 59 131 58 135 65 89 66Z',ink)+path('M108 93 128 90 139 126 192 107 205 114 143 146 107 136 65 159 48 153 93 123Z',ink)+path('M109 134 88 169 122 166 104 206 123 209 138 160 130 133Z',ink)],
 ['克勞德・莫內','lily_bridge','睡蓮橋',['#70aa8f','#96b7d1','#efa7b6'],()=>path('M30 144 Q128 42 226 144 L220 158 Q128 70 36 158Z','#638d65',paper,5)+path('M42 139 42 110 M77 115 77 86 M111 104 111 77 M147 104 147 77 M180 116 180 88 M212 140 212 114 M40 111 Q128 42 214 114','none','#2d695d',7)+path('M35 181 Q80 164 124 180 T222 181 M51 207 Q106 193 197 208','none','#a1c3d7',7)+path('M83 182 Q105 151 131 182 Q123 191 83 182 M156 211 Q179 181 206 209 Q197 219 156 211','#6dac84')+path('M104 180 Q81 164 95 147 Q105 151 108 164 Q111 137 124 144 Q136 157 120 173 Q145 155 146 174 Q129 187 104 180Z','#eca9bb',ink,3)],
 ['奧古斯特・雷諾瓦','umbrella','雨中巴黎',['#648eac','#e3b575','#d6886c'],()=>path('M38 122 Q50 46 124 46 Q202 50 220 130 Q195 113 171 132 Q149 113 125 128 Q103 110 82 127 Q60 110 38 122Z','#618dab',paper,5)+path('M124 46 Q82 61 82 127 Q103 110 125 128 Q144 109 171 132 Q168 74 124 46Z','#c4b993',ink,3)+path('M127 39 127 183 Q129 218 107 218 Q89 218 91 199','none','#dfac6f',10)+path('M41 164 34 179 M70 197 63 211 M186 162 177 181 M217 186 211 199','none','#88b8c7',5)],
 ['艾德加・竇加','ballet_ribbon','芭蕾緞帶',['#e9b2a6','#9697bc','#e6d3b7'],()=>path('M91 107 Q57 125 73 191 Q80 218 98 211 Q123 200 118 151 L111 112Z','#dca99d',paper,5)+path('M146 101 Q117 122 131 181 Q141 218 160 207 Q184 190 166 127 L158 107Z','#baa5b7',paper,5)+path('M92 117 Q89 167 96 194 M144 113 Q146 160 155 192','none','#82597b',5)+path('M101 119 C62 53 78 31 121 75 C158 18 184 54 143 109 M121 75 Q145 106 186 82 M121 75 Q94 105 62 92','none','#f0d6b8',9)],
 ['貝爾特・莫利索','butterfly','捕蝶',['#e1b2b0','#7aa58b','#d8cf92'],()=>path('M124 137 C78 18 21 43 46 123 Q58 154 113 151 C55 146 58 205 104 194 Q126 181 128 151 C141 218 196 202 194 168 Q190 147 141 149 C241 150 233 42 183 52 Q151 67 132 136Z','#d9a4ae',paper,5)+path('M114 131 Q63 70 60 93 Q64 124 114 137 M144 134 Q198 70 203 88 Q208 128 144 139Z','#86a994')+path('M123 137 134 154 M126 138 Q123 101 113 89 M132 139 Q144 108 154 99','none',ink,5)+path('M106 181 Q85 211 44 218','none','#cbd091',7)],
 ['卡米耶・畢沙羅','orchard','果園小徑',['#729d68','#d9b46a','#d18054'],()=>path('M43 213 Q140 176 216 210 L213 226 42 226Z','#c2b579')+path('M116 218 Q153 192 153 155 L171 157 Q165 197 154 222Z','#e9d59b')+path('M71 194 75 99 M180 181 179 100 M129 167 128 65','none','#746044',10)+path('M36 121 Q20 91 53 73 Q71 47 97 69 Q128 74 113 111 Q109 139 78 132 Q43 145 36 121 M146 122 Q133 89 163 73 Q190 46 213 73 Q245 93 221 124 Q190 145 146 122 M96 76 Q78 47 104 30 Q132 15 153 37 Q181 50 159 79 Q125 100 96 76Z','#71935d',paper,4)+circle(63,95,7,'#dc9655')+circle(93,105,6,'#dfbb6e')+circle(121,51,7,'#dda65a')+circle(191,91,7,'#cd835a')+circle(204,115,6,'#e2b267')],
 ['瑪麗・卡薩特','opera_glasses','包廂裡的視線',['#8faebf','#ddb98a','#ba7c87'],()=>path('M47 51 Q125 18 213 55 L200 211 Q128 187 52 218Z','#7e627c',paper,5)+path('M67 120 78 80 110 78 120 113 145 111 151 77 185 80 194 121 180 161 142 159 137 136 121 137 114 165 75 166Z','#d5b285',ink,6)+circle(95,141,25,ink)+circle(166,137,25,ink)+circle(95,141,16,'#7bb6c4')+circle(166,137,16,'#7bb6c4')+path('M86 134 94 130 M157 130 165 127','none',paper,5)+path('M177 170 Q202 211 171 222','none','#dfba8a',8)],
];
...
// 指定寬度可以讓字在系統換字型時還是排得住。
// 這裡的文字全部是程式畫出來的，沒有外部字型、圖片或濾鏡。
function lettering(label,x,y,width,size,{fill=paper,outline=ink,stroke=7,angle=0,anchor='middle',shadow=true}={}){
 // 中文是方塊字，Impact 這種窄體不是。同樣的 font-size，Impact 的字高只有約 0.72 em，
 // 中文字卻佔到 0.86 em —— 直接沿用原字級會比原本高一截，壓到上面那一行。
 // 這裡把中文縮到 0.85 倍，視覺高度就跟原本的英文一致，版面不會互相打架。
 const cjk=/[\u3000-\u303f\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff\uff00-\uffef]/.test(label);
 ...
 // 再夾一道「不可超過版位寬 ÷ 字數」，字多的時候才不會橫向爆框。
 const fontSize=cjk?Math.round(Math.min(size*.85,width/Math.max(1,count))):size;
 // 字比版位窄時不要硬撐滿，拉開太多會散掉；最多放寬到字身的 1.3 倍。
 const span=cjk?Math.min(width,Math.round(count*fontSize*1.3)):width;
 const adjust=cjk?'spacing':'spacingAndGlyphs';
 const text=(dx,dy,color,edge,weight)=>`<text x="${x+dx}" y="${y+dy}" text-anchor="${anchor}" textLength="${span}" lengthAdjust="${adjust}" font-family='${family}' font-size="${fontSize}" font-weight="900" letter-spacing="${cjk?0:1}" fill="${color}" stroke="${edge}" stroke-width="${weight}" paint-order="stroke fill" stroke-linejoin="round">${escapeXML(label)}</text>`;
...
const fullTags={
 sunflower:{taunt:'還在開花中',draw(){
  ...
  s+=lettering('還在',382,168,156,75,{angle:10,fill:'#efb93d'});
  s+=path('M35 383 466 343 482 431 58 484 34 456Z',ink,paper,5)+lettering('開花中',258,432,417,76,{angle:-6,fill:'#ffd16b',stroke:3});
  return s+line('M83 468 117 464 M353 449 434 440','#efb93d',7);
 }},
 red_tree:{taunt:'你的現實需要重畫',draw(){
  ...
  s+=lettering('你的現實',231,109,357,52,{fill:ink,outline:'#e79861',stroke:3,angle:-3,shadow:false});
  s+=lettering('需要',156,352,211,68,{angle:-7,fill:'#efbf83'});
  s+=lettering('重畫',334,448,264,101,{angle:6,fill:paper});
  return s+line('M63 407 153 393 M370 205 428 180','#efbf83',7)+circle(87,296,9,'#efbf83')+circle(437,323,7,ink);
 }},
 mountain_apple:{taunt:'靜物畫完，換你出手',draw(){
  ...
  s+=lettering('靜物畫完',266,118,336,69,{angle:-8,fill:paper});
  s+=lettering('換你出手',274,463,377,67,{angle:-5,fill:'#efc774'});
  return s;
 }},
 dot_sun:{taunt:'點到為止',draw(){
  ...
  s+=path('M26 82 414 48 428 159 41 188Z',ink,paper,5)+lettering('點到',225,145,341,107,{angle:-5,fill:'#efb553'});
  s+=path('M98 350 475 324 482 432 101 476 76 432Z',ink,paper,5)+lettering('為止',283,431,336,104,{angle:-5,fill:'#65a5b5'});
  return s+circle(63,458,13,'#d57965')+circle(41,434,7,'#efb553');
 }},
 dotted_sail:{taunt:'吃我的浪',draw(){
  ...
  s+=lettering('吃我',337,119,262,66,{angle:9,fill:'#ed9d5a'});
  s+=lettering('的浪',255,440,353,112,{angle:-8,fill:paper});
  return s+speckle(419,391,50,29,['#65bccc','#fff0cd','#ed9d5a'],12,4,4);
 }},
 poster_star:{taunt:'你只是來暖場',draw(){
  ...
  s+=lettering('你只是',254,129,340,67,{angle:4,fill:'#e6bc66',stroke:2});
  s+=lettering('來暖場',264,427,362,86,{angle:-6,fill:paper});
  return s+line('M351 136 377 105 M386 172 421 160 M144 215 161 238',ink,8);
 }},
 lily_bridge:{taunt:'對焦失敗',draw(){
  ...
  s+=lettering('對焦',243,121,323,84,{angle:-3,fill:'#cfe4d2'});
  s+=lettering('失敗',279,434,332,111,{angle:4,fill:'#efa7b6'});
  return s;
 }},
 umbrella:{taunt:'我的陰影比你的好看',draw(){
  ...
  s+=lettering('我的陰影',259,151,338,67,{angle:-5,fill:paper});
  s+=lettering('比你的',262,339,312,71,{angle:-3,fill:'#e3b575'});
  s+=lettering('好看',262,423,352,106,{angle:-3,fill:'#d6886c'});
  return s+line('M57 264 42 286 M87 481 77 493 M482 279 471 307 M42 347 28 371 M453 462 447 481','#88b8c7',9);
 }},
 ballet_ribbon:{taunt:'腳步給我站好了',draw(){
  ...
  s+=lettering('腳步給我',248,104,347,64,{angle:-4,fill:'#e9b2a6'});
  s+=path('M39 398 466 366 474 438 69 485Z',ink,paper,5)+lettering('站好了',259,439,388,83,{angle:-5,fill:'#e6d3b7',stroke:2});
  return s;
 }},
 butterfly:{taunt:'你釘不住我的翅膀',draw(){
  ...
  s+=lettering('你釘不住',235,118,335,63,{angle:-6,fill:'#e1b2b0'});
  s+=path('M29 378 433 346 461 435 59 483Z','#7aa58b',ink,5)+lettering('我的翅膀',245,437,374,80,{angle:-6,fill:paper});
  return s;
 }},
 orchard:{taunt:'你熟了，該摘了',draw(){
  ...
  s+=lettering('你熟了',257,116,348,72,{angle:-3,fill:'#d9b46a'});
  s+=path('M111 374 464 354 474 439 134 478Z',ink,paper,5)+lettering('該摘了',289,439,319,93,{angle:-4,fill:'#d9b46a',stroke:2});
  return s;
 }},
 opera_glasses:{taunt:'我看夠了吧',draw(){
  ...
  s+=lettering('我看',250,128,307,90,{angle:1,fill:paper});
  s+=lettering('夠了吧',256,432,389,94,{angle:-2,fill:'#ddb98a'});
  return s;
 }},
};
