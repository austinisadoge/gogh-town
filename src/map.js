...
catch(e){$('#error').style.display='block';$('#error').textContent='這個顏料世界需要 WebGL。請開啟圖形加速後重新整理。';throw e;}
...
renderer.domElement.id='world';renderer.domElement.tabIndex=0;renderer.domElement.setAttribute('aria-label','梵谷小鎮大作戰的遊戲世界。點一下鎖定滑鼠。');
