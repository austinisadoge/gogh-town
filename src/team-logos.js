...
export const TEAM_LOGOS=Object.freeze([
 Object.freeze({id:0,name:'黃屋幫',description:'一顆奔放的太陽壓在受亞爾啟發的工作室屋頂上，最後補一枝畫筆。',
  svg:wrap('黃屋幫',`
 ...
 Object.freeze({id:1,name:'獨立派',description:'一個敞開的畫框、一枝溢出邊界的筆，和一道閃光。',
  svg:wrap('獨立派',`
   <g stroke-linejoin="round" stroke-linecap="round">
