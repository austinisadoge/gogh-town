...
const RESOLUTION = 3;
const HEIGHT = 25;
const FONT = '600 13px -apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang TC", "Noto Sans TC", "Microsoft JhengHei", sans-serif';
...
export function createNameplate(name) {
  ...
  const label = String(name || '畫家').trim().replace(/\s+/g, ' ');
  context.font = FONT;
