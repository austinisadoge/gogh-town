/** 虛構的競技動作，不代表任何歷史流派的主張。
 * 關節位移量是無單位的相對值，完全不影響物理運算。
 */
const TAU=Math.PI*2,clamp=(v,a=0,b=1)=>Math.max(a,Math.min(b,v));
const smooth=v=>{const t=clamp(v);return t*t*(3-2*t);};
export const ARTIST_TAUNTS=Object.freeze([
 ['文森・梵谷','sunflower_spin','向日葵旋轉',1.60],
 ['保羅・高更','crimson_swagger','赤紅搖擺',1.58],
 ['保羅・塞尚','mountain_measure','丈量那座山',1.66],
 ['喬治・秀拉','dotted_shuffle','點描碎步',1.56],
 ['保羅・席涅克','sailor_flourish','水手的花招',1.62],
 ['亨利・羅特列克','poster_bow','海報式謝幕',1.62],
 ['克勞德・莫內','bridge_sway','橋上搖擺',1.68],
 ['奧古斯特・雷諾瓦','paris_two_step','巴黎兩步舞',1.60],
 ['艾德加・竇加','curtain_call','謝幕',1.64],
 ['貝爾特・莫利索','butterfly_turn','蝴蝶迴旋',1.58],
 ['卡米耶・畢沙羅','orchard_welcome','果園迎賓',1.66],
 ['瑪麗・卡薩特','opera_encore','歌劇安可',1.60],
// 讓整套動作跑完看得清楚，同時保留每位畫家自己的節奏。
