...
http.createServer(async(req,res)=>{try{
 ...
 if(url==='/health'){res.writeHead(200,{'Content-Type':'application/json'});res.end(JSON.stringify({app:'梵谷小鎮大作戰',version:'1.0.0'}));return;}
...
}).listen(port,'127.0.0.1',()=>console.log(`梵谷小鎮大作戰已啟動：http://127.0.0.1:${port}`));
